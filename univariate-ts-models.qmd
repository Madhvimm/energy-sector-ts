...
#Plot the residuals
plot1_gdp <- autoplot(resid_gdp_ts, series="Detrended GDP", colour = "#499995") + 
  theme_bw() +
  xlab("Time") +
  ylab("Residuals") +
...
#Differencing plot
plot2_gdp <- autoplot(diff(gdp_ts), series = "First Difference GDP", colour = "#99494d") + 
  theme_bw() +
  xlab("Time") +
  ylab("Differences") +
...
#Plot the residuals
plot1_cpi <- autoplot(resid_cpi_ts, series="Detrended CPI", colour = "#499995") + 
  theme_bw() +
  xlab("Time") +
  ylab("Residuals") +
...
#Differencing plot
plot2_cpi <- autoplot(diff(cpi_ts), series = "First Difference CPI", colour = "#99494d") + 
  theme_bw() +
  xlab("Time") +
  ylab("Differences") +
