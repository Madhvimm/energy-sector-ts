...
# First, we take the first difference of the time series to make it stationary
diff_crude_oil_ts <- diff(composite_crude_oil_ts, differences = 1)

# Applying the ADF test to the differenced time series
...
# First, take the first difference of the time series to make it stationary
diff_citygate_gas_ts <- diff(citygate_gas_ts, differences = 1)

# Make sure to remove any NA values that might have been introduced by differencing
diff_citygate_gas_ts <- na.omit(diff_citygate_gas_ts)

# Now, apply the ADF test to the differenced time series
...
# Remove any NA values that might have been introduced by differencing
