...
elect_log_ts <- ts(total_electricity_prices$LOG_Value, start=c(start_year_elec, start_month_elec), frequency=12)
...
crude_oil_df <- data.frame(
  Date = seq(as.Date("1973-10-01"), by = "month", length.out = length(oil_log_ts)),
  LOG_Value = as.vector(oil_log_ts)
)

# Calculate moving averages with the specified window sizes
crude_oil_df$ma5 <- zoo::rollmean(crude_oil_df$LOG_Value, 5, mean, fill = NA, align = "right")
crude_oil_df$ma15 <- zoo::rollmean(crude_oil_df$LOG_Value, 15, mean, fill = NA, align = "right")
crude_oil_df$ma20 <- zoo::rollmean(crude_oil_df$LOG_Value, 20, mean, fill = NA, align = "right")
crude_oil_df$ma30 <- zoo::rollmean(crude_oil_df$LOG_Value, 30, mean, fill = NA, align = "right")
...
natural_gas_df <- data.frame(
  Date = seq(as.Date("1973-10-01"), by = "month", length.out = length(gas_log_ts)),
  LOG_Value = as.vector(gas_log_ts)
)

#head(natural_gas_df)

# Calculate moving averages with the specified window sizes
natural_gas_df$ma5 <- zoo::rollmean(natural_gas_df$LOG_Value, 5, mean, fill = NA, align = "right")
natural_gas_df$ma15 <- zoo::rollmean(natural_gas_df$LOG_Value, 15, mean, fill = NA, align = "right")
natural_gas_df$ma20 <- zoo::rollmean(natural_gas_df$LOG_Value, 20, mean, fill = NA, align = "right")
natural_gas_df$ma30 <- zoo::rollmean(natural_gas_df$LOG_Value, 30, mean, fill = NA, align = "right")
...
# Calculate moving averages with the specified window sizes
total_electricity_prices$ma5 <- zoo::rollmean(total_electricity_prices$LOG_Value, 5, mean, fill = NA, align = "right")
total_electricity_prices$ma15 <- zoo::rollmean(total_electricity_prices$LOG_Value, 15, mean, fill = NA, align = "right")
total_electricity_prices$ma20 <- zoo::rollmean(total_electricity_prices$LOG_Value, 20, mean, fill = NA, align = "right")
total_electricity_prices$ma30 <- zoo::rollmean(total_electricity_prices$LOG_Value, 30, mean, fill = NA, align = "right")
```
...
# Calculate moving averages with the specified window sizes
gdp_data$ma5_log <- rollmean((gdp_data$LOG_GDP), 5, fill = NA, align = "right", by = 4)  # Considering quarterly data
gdp_data$ma15_log <- rollmean((gdp_data$LOG_GDP), 15, fill = NA, align = "right", by = 4)
gdp_data$ma20_log <- rollmean((gdp_data$LOG_GDP), 20, fill = NA, align = "right", by = 4)
gdp_data$ma30_log <- rollmean((gdp_data$LOG_GDP), 30, fill = NA, align = "right", by = 4)
...
# Calculate moving averages with the specified window sizes
cpi_data$ma5_log <- rollmean(cpi_data$LOG_CPI, 5, fill = NA, align = "right")
cpi_data$ma15_log <- rollmean(cpi_data$LOG_CPI, 15, fill = NA, align = "right")
cpi_data$ma20_log <- rollmean(cpi_data$LOG_CPI, 20, fill = NA, align = "right")
cpi_data$ma30_log <- rollmean(cpi_data$LOG_CPI, 30, fill = NA, align = "right")
...
<a href="data-visualization.qmd" class="previous-page-link" style="float: left;">&larr; Previous Page: Data Viz</a>



<a href="univariate-ts-models.qmd" class="next-page-link" style="float: right;">Next Page: Univariate &rarr;</a>
