...
- The consistent distribution of quarterly colors across lags indicates an even inflation rate across all quarters.
...
# Plot the decomposed components
autoplot(decomposed_natural_gas, colour = "turquoise4") + 
  ggtitle("Decomposition Plot for Natural Gas Price") +
  theme_bw()
...
# Plot the decomposed components
autoplot(decomposed_electricity, colour = "turquoise4") + 
  ggtitle("Decomposition Plot for Average Price of Electricity to Ultimate Customers") +
  theme_bw()
...
# Plot the decomposed components
autoplot(decomposed_gdp, colour = "turquoise4") + 
  ggtitle("Decomposition Plot for GDP") +
  theme_bw()
...
# Plot the decomposed components
autoplot(decomposed_cpi, colour = "turquoise4") + 
  ggtitle("Decomposition Plot for CPI") +
  theme_bw()
