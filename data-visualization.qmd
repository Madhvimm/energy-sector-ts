...
# Ensure your individual datasets have a 'Type' column and a 'Price' column
crude_oil_prices <- composite_crude_oil_prices %>% 
  mutate(Type = "Crude Oil", Price = Value) %>%
...
#
p <- plot_ly(data = combined_data, x = ~Date, y = ~Price, color = ~Type, type = 'scatter', mode = 'lines') %>%
...
<iframe src="https://public.tableau.com/views/ProjectTableau_17115959999840/Dashboard1?:embed=y&:showVizHome=no" width="100%" height="1200" frameborder="0"></iframe>
